...
- Introduced the first self-alignment framework based on [Mistake Analysis](https://arxiv.org/abs/2310.10477) (ICLR), enhancing content safety pass rates by over 20% while maintaining model performance; further extended to the multi-modality model alignment method [ECSO](https://gyhdog99.github.io/projects/ecso/) (ECCV).
- Established [CoSafe](https://arxiv.org/abs/2406.17626) (EMNLP), a benchmark for evaluating safety in multi-turn dialogues for large models; systematically assessed model safety across multiple dialogue rounds.
