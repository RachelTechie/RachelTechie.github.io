...
- Proposed the LLM self-alignment framework [Mistake Analysis](https://arxiv.org/abs/2310.10477) (ICLR), enhancing LLM's safety pass rates by over 20% while maintaining the model performance; further extended to the multi-modality model alignment [ECSO](https://gyhdog99.github.io/projects/ecso/) (ECCV).
- Established [CoSafe](https://arxiv.org/abs/2406.17626) (EMNLP), a benchmark for evaluating LLM's safety in multi-turn dialogues; systematically assessed model safety performance across multiple dialogue rounds.
